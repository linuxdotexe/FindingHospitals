...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		String timeStamp = new SimpleDateFormat("d-MM-YY-HH-mm-ss").format(new Date());// time stamp
		...
		sparkReporter.config().setReportName("Practo Test Scenarios"); // name of the report
